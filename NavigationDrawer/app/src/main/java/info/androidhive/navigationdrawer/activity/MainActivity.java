...
import info.androidhive.navigationdrawer.fragment.SignupFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static String background = "http://api.androidhive.info/images/nav-menu-header-bg.jpg";
    private static String photo = "http://pausaparavaidade.com/wp-content/uploads/2014/10/os-personagens-mais-ricos-10.png";


    private static final String urlNavHeaderBg = background; //"http://api.androidhive.info/images/nav-menu-header-bg.jpg";
    private static final String urlProfileImg =  photo;  //"https://lh3.googleusercontent.com/eCtE_G34M9ygdkmOpYvCag1vBARCmZwnVS6rS5t4JLzJ6QgQSBquM0nuTsCpLhYbKljoyS-txg";
